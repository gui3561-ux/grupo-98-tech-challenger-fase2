...
comportamento dos usuários. Este projeto implementa um sistema de recomendação usando o dataset MovieLens 100K. O pipeline cobre desde o processamento dos dados até o registro do modelo em produção, com rastreamento de experimentos, versionamento via DVC e containerização com Docker.
...
**Rodar o pipeline de treino via Docker:**
